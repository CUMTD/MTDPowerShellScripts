...
function New-DispositionReport {
    ...
    # Write detail CSV
    if ($PSCmdlet.ShouldProcess($DetailOutputCsvPath, "Export detailed disposition report to CSV")) {
        $detailResults |
    ...
    if ($PSCmdlet.ShouldProcess($SummaryOutputCsvPath, "Export summary disposition report to CSV")) {
        $summaryResults |

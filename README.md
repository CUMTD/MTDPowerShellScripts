...
> **Note:** The installer auto-detects whether it lives in a `Scripts` folder or alongside the module files in the release zip, so you can run it from either location after extracting.
